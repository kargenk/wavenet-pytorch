...
def get_parser():
    ...
    parser.add_argument("utt_list", type=str, default='../data/train.list', help="utternace list")
    parser.add_argument("lab_root", type=str, default='../data/jsut_ver1.1/basic5000/lab', help="label directory")
    parser.add_argument("qst_file", type=str, default='../data/qst1.hed', help="HTS style question file")
    parser.add_argument("out_dir", type=str, default='../data/dump/jsut_sr16000/org/train', help="out directory")
...
if __name__ == "__main__":
    ...
    in_dir = Path(args.out_dir) / "in_dulation"
    out_dir = Path(args.out_dir) / "out_dulation"
